...
describe('UserEntity integration tests', () => {
  describe('Constructor method', () => {
    it('Should throw an error when creating a user with invalid companyId', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        companyId: null,
      }
  ...
  describe('refreshUpdatedAt method', () => {
    it('Should a invalid user using updatedAt field', () => {
      const entity = new UserEntity(UserDataBuilder({}))

      expect(() => entity.refreshUpdatedAt('2023' as any)).toThrow(
        EntityValidationError,
      )

      expect(() => entity.refreshUpdatedAt('' as any)).toThrow(
        EntityValidationError,
      )
      expect(() => entity.refreshUpdatedAt(10 as any)).toThrow(
        EntityValidationError,
      )
    })
    ...
    it('Should a valid user', () => {
      ...
      const entity = new UserEntity(props)
      entity.refreshUpdatedAt(new Date())
    })
  })

  describe('setDeletedAt method', () => {
    it('Should a invalid user using updatedAt field', () => {
      const entity = new UserEntity(UserDataBuilder({}))

      expect(() => entity.setDeletedAt('2023' as any)).toThrow(
        EntityValidationError,
      )

      expect(() => entity.setDeletedAt('' as any)).toThrow(
        EntityValidationError,
      )
      expect(() => entity.setDeletedAt(10 as any)).toThrow(
        EntityValidationError,
      )
    })
